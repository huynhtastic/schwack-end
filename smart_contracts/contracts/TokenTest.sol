...
contract BasicToken is ERC20Basic, Freezing {
  ...
  function accessAccountTransfer(address _to, uint _value)
    public
    onlyPayloadSize(2 * 32)
...
contract StandardToken is ERC20, BasicToken {
  ...
  function transferFrom(
    ...
    whenNotFreezeOf(_to) // this catches during HTLC since the contract address is not approved, must approve first
    returns (bool)
  {
    require(_to != address(0));
...
contract TokenTest is MintableToken {
